...
public class ProductServiceTest {
	...
	public void testListProduct() {
		...
		PageInfo<ProductDAO> pageInfo = productService.listProductPage(product, null);
		for (ProductDAO tempProductDAO : pageInfo.getList()) {
			System.out.println(tempProductDAO);
		}
	}
    ...
    public void testGetProductByCategory2Id() {
		ProductService productService = (ProductService) this.application.getBean("productService");
		List<ProductDAO> productList = productService.listProductByCategory2Id(23L);

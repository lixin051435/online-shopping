...
public class Category1ServiceImpl implements Category1Service {
	...
	@Override
	public List<Category1DAO> listCategory1DAO(Category1 category1) {
		
		List<Category1DAO> category1DAOList = this.category1Mapper.listCategory1DAO(category1);
		
		return category1DAOList;
	}

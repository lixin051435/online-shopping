...
import com.cj.shopping.sysmanage.dao.Category2DAO;
...
import com.cj.shopping.sysmanage.mapper.Category2Mapper;
import com.cj.shopping.sysmanage.service.Category2Service;

/**
 * 类描述：二级类目服务接口的实现类
 * 类名称：Category2ServiceImpl
 */
...
public class Category2ServiceImpl implements Category2Service {
	...
	@Override
	public Category2DAO getCategory2ById(Long category2Id) {
		// category2DTO中还包括一级类目的名称
		Category2DAO category2DAO = this.category2Mapper.getCategory2ById(category2Id);
		return category2DAO;
	}
	...
	@Override
	public List<Category2DAO> listCategory2(Category2 category2) {
		List<Category2DAO> category2List = this.category2Mapper.listCategory2(category2);
		
		return category2List;
	}
	
	@Override
	public PageInfo<Category2DAO> listCategory2Page(Category2 category2, PageParam pageParam) {
		...
		List<Category2DAO> category2List = this.category2Mapper.listCategory2(category2);
		// 构造分页信息对象
		PageInfo<Category2DAO> pageInfo = new PageInfo<Category2DAO>(category2List);

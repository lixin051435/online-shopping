...
public interface Category2Service {
	 ...
	 * @return 查询到的二级类目
	 */
	Category2DAO getCategory2ById(Long category2Id);
	 ...
	 */
	List<Category2DAO> listCategory2(Category2 category2);
	
	/**
	 * 查询二级类目的列表
	 * @return 封装有二级类目列表的 PageInfo
	 */
	PageInfo<Category2DAO> listCategory2Page(Category2 category2, PageParam pageParam);

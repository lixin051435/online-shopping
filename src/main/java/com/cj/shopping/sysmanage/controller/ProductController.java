...
public class ProductController {
	...
	public String gotoProductList(HttpSession session) {
		...
		List<Category1DAO> category1List = category1Service.listCategory1DAO(null);
		List<Category2DAO> category2List = category2Service.listCategory2(null);
	...
	public @ResponseBody Map<String, Object> listProduct(@RequestBody Product product,
		...
		PageInfo<ProductDAO> productInfo = this.productService.listProductPage(product, pageParam);
		// 1.获取商品列表
		List<ProductDAO> productList = productInfo.getList();
		// 2.获取分页条

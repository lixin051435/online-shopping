...
public class Category2Controller {
	...
	public String gotoCategory2List(HttpSession session) {
		...
		// 同时也加载所有的一级类目，便于查询
		List<Category1DAO> category1DAOList = this.category1Service.listCategory1DAO(null);
	...
	public @ResponseBody Map<String, Object> listCategory2(String category2Name,
		...
		// 3.分页查询
		PageInfo<Category2DAO> pageInfo = category2Service.listCategory2Page(category2, pageParam);
		
		// 获取二级类目列表
		List<Category2DAO> category2List = pageInfo.getList();
		// 获取分页条
	...
	public @ResponseBody Map<String, Object> getCategory2ById(Long category2Id) {
		...
		Category2DAO category2 = this.category2Service.getCategory2ById(category2Id);

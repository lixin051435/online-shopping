    ...
    <c:if test="${sessionScope.cart.cartItems.size() != 0 }">
        <div class="span24">
                    ...
                    <tr>
                        <td width="200">
                            <a href="${pageContext.request.contextPath }/findByPid/<c:out value="${cartItem.product.productId}"/>">
                                <img width="100%" src="${pageContext.request.contextPath}${cartItem.product.imgSrc}"/>
                            </a>
                        </td>
                        <td>
                            <a target="_blank"
                        ...
                        <td>
                            <a href="${ pageContext.request.contextPath }/removeCar?productId=<c:out value="${cartItem.product.productId}"/>"
                               class="delete">删除</a>
                        </td>
                    </tr>
                </c:forEach>
            ...
            <div class="bottom">
                ...
                <a href="${pageContext.request.contextPath}/toOrderPage" id="submit" class="submit">提交订单</a>
            </div>
        </div>
    </c:if>
</div>

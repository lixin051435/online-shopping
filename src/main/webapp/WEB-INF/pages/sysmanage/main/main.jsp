...
<body>
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list" id="nav_list">
					...
					<li><a href="#" class="dropdown-toggle"><i
						...
						<ul class="submenu">
							<li class="home"><a href="javascript:void(0)"
								name="${ctx}/sysmgr/order/gotoOrderList" title="订单管理" class="iframeurl"><i
									class="icon-double-angle-right"></i>订单列表</a></li>
						</ul></li>
					<li><a href="#" class="dropdown-toggle"><i
							class="icon-cogs"></i><span class="menu-text"> 留言管理 </span><b
							class="arrow icon-angle-down"></b></a>
						<ul class="submenu">
							<li class="home"><a href="javascript:void(0)"
												name="${ctx}/sysmgr/message/gotoMessageList" title="留言列表" class="iframeurl"><i
	...
	<div class="footer_style" id="footerstyle">
		<p>Copyright 版权所有 Powered by 网上商城</p>
	</div>
	<!--修改密码样式-->
